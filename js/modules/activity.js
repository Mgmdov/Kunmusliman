...
window.openActivityView = function() {
  ...
  html += '<button onclick="document.getElementById(\'activityOverlay\').remove()" style="background:none;border:none;color:#007AFF;font-size:15px;cursor:pointer;">← Назад</button>';
  html += '<h2 style="margin:0;font-size:18px;">Активность</h2>';
