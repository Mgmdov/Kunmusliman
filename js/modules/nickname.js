...
function injectProfile(){
  ...
  var html='<div style="margin-top:12px;display:flex;flex-direction:column;gap:8px;">'+
    '<div style="display:flex;gap:8px;align-items:center;">'+
      ...
      '<input type="text" class="nick-input" placeholder="Введите никнейм" value="'+nick+'" style="flex:1;padding:10px 14px;border-radius:12px;border:1px solid rgba(0,0,0,0.1);font-size:14px;background:rgba(0,0,0,0.03);" onchange="window.setNickname(this.value)">'+
    '</div>'+
